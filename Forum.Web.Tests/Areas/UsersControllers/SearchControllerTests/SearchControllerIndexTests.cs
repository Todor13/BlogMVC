...
namespace Forum.Web.Tests.Areas.UsersControllers.SearchControllerTests
{
    [TestFixture]
    public class SearchControllerIndexTests
    {
        [Test]
        public void Users_SearchController_Index_ShouldReturnCorrectModel()
        {
            // Arrange
        ...
        [TestCase("Test")]
        [TestCase("tEST")]
        public void Users_SearchController_Index_ShouldReturnCorrectUserCollectionConvertedToUserViewModelAtPage1(string query)
        {
            // Arrange
            var data = new Mock<IUowData>();
            var pagerFactory = new Mock<IPagerViewModelFactory>();
            ...
            // Act
            var result = controller.Index(query) as ViewResult;
        ...
        [Test]
        public void Users_SearchController_Index_ShouldReturnCorrectUserCollectionConvertedToUserViewModelAtPage2()
        {
            // Arrange
            var data = new Mock<IUowData>();
            var pagerFactory = new Mock<IPagerViewModelFactory>();
            ...
            // Act
            var result = controller.Index("Test", 2) as ViewResult;
            var resultModel = result.Model as Tuple<IEnumerable<UserViewModel>, IPagerViewModel>;
        ...
        [TestCase(13)]
        [TestCase(12899953)]
        public void Users_SearchController_Index_ShouldReturnCallPagerViewModelFactoryWithCorrectData(int page)
        {
            // Arrange
            var data = new Mock<IUowData>();
            var pagerFactory = new Mock<IPagerViewModelFactory>();
            ...
            // Act
            var result = controller.Index("test", page) as ViewResult;

            // Assert
            pagerFactory.Verify(p => p.CreatePagerViewModel("Search", page, UsersCollection().Count, WebConstants.UsersPageSize));
        }

        [Test]
        public void Users_SearchController_Index_ShouldReturnModelWithCorrectControllerName()
        {
            // Arrange
            var data = new Mock<IUowData>();
            var pagerFactory = new Mock<IPagerViewModelFactory>();
        ...
        [TestCase(3)]
        [TestCase(8568903)]
        public void Users_SearchController_Index_ShouldReturnModelWithCorrectCurrentPage(int page)
        {
            // Arrange
            var data = new Mock<IUowData>();
            var pagerFactory = new Mock<IPagerViewModelFactory>();
        ...
        [TestCase(9)]
        [TestCase(86432)]
        public void Users_SearchController_Index_ShouldReturnModelWithCorrectItemsCount(int itemsCount)
        {
            // Arrange
            var data = new Mock<IUowData>();
            var pagerFactory = new Mock<IPagerViewModelFactory>();
        ...
        [TestCase(87)]
        [TestCase(653435)]
        public void Users_SearchController_Index_ShouldReturnModelWithCorrectPagesCount(int pagesCount)
        {
            // Arrange
            var data = new Mock<IUowData>();
            var pagerFactory = new Mock<IPagerViewModelFactory>();
        ...
        [TestCase(112)]
        [TestCase(9854445)]
        public void Users_SearchController_Index_ShouldReturnModelWithCorrectPageSize(int pageSize)
        {
            // Arrange
            var data = new Mock<IUowData>();
            var pagerFactory = new Mock<IPagerViewModelFactory>();
